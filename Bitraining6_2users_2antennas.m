...
for Realization = 1 : N_Realizations
    ...
    for numiters = 1:length(iternums)
        ...
        %% bi-directional training
            ...
            [v11b, v12b, v21b, v22b] = MSE_b_2users_2antennas(Z11, Z12, Z21, Z22, g1b, g2b, n0);
            [v11c, v12c, v21c, v22c] = MSE_b_2users_2antennas(Z11, Z12, Z21, Z22, g1c, g2c, n0);
            v12c = [0;0];
            v21c = [0;0];
            ...
            [v11, v12, v21, v22] = Primal_Dual_2users_2antennas(H11, H12, H21, H22, g1, g2, P, n0);
            ...
            [g1, g2] = MSE_f_2users_2antennas(H11, H12, H21, H22, v11, v12,  v21, v22, n0);
            [g1b, g2b] = MSE_f_2users_2antennas(H11, H12, H21, H22, v11b, v12b, v21b, v22b, n0);
            [g1c, g2c] = MSE_f_2users_2antennas(H11, H12, H21, H22, v11c, v12c, v21c, v22c, n0);
            ...
            SINR1b = norm(g1b'*(H11*v11b+H12*v21b))^2/((norm(g1b'*(H11*v12b+H12*v22b)))^2+n0*g1b'*g1b);
            SINR2b = norm(g2b'*(H21*v12b+H22*v22b))^2/((norm(g2b'*(H21*v11b+H22*v21b)))^2+n0*g2b'*g2b);
           
            C1b(Realization, numiters) = abs(log2(1+SINR1b));
            C2b(Realization, numiters) = abs(log2(1+SINR2b));

            
            SINR1c = norm(g1c'*(H11*v11c+H12*v21c))^2/((norm(g1c'*(H11*v12c+H12*v22c)))^2+n0*g1c'*g1c);
            SINR2c = norm(g2c'*(H21*v12c+H22*v22c))^2/((norm(g2c'*(H21*v11c+H22*v21c)))^2+n0*g2c'*g2c);
...
axis([1 numiters 15 25])

xlabel('Number of iterations')
ylabel('C(bits/channel)')
title('Capacity vs. Iterations: 2 users;2 antennas;P=1;n0=10^{-3};100 realizations')
