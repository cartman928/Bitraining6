function [v11, v12, v13, v21, v22, v23, v31, v32, v33] = Primal_Dual_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, g1, g2, g3, P, n0)
%Duality

%Constants
lambda = [0;0;0];%Staring Point
v = zeros(36,1);%Staring Point
Lam = diag([lambda(1) lambda(1) lambda(1) lambda(1) lambda(2) lambda(2) lambda(2) lambda(2) lambda(3) lambda(3) lambda(3) lambda(3)]);
...
ABCLam =  [A+B+C+Lam 0*eye(12) 0*eye(12);0*eye(12) A+B+C+Lam 0*eye(12);0*eye(12) 0*eye(12) A+B+C+Lam];
...
stepsize = 5*10^(-2);    
            ...
            D_g = [norm(v(1:4))^2+norm(v(13:16))^2+norm(v(25:28))^2-P;norm(v(5:8))^2+norm(v(17:20))^2+norm(v(29:32))^2-P;norm(v(9:12))^2+norm(v(21:24))^2+norm(v(33:36))^2-P];
            ...
            [real(Lp) real(Ld) norm(v(1:4))^2+norm(v(13:16))^2+norm(v(25:28))^2 norm(v(5:8))^2+norm(v(17:20))^2+norm(v(29:32))^2 norm(v(9:12))^2+norm(v(21:24))^2+norm(v(33:36))^2]
