...
for Realization = 1 : N_Realizations
    ...
    for numiters = 1:length(iternums)
        ...
        %% bi-directional training
            ...
            [v11b, v12b, v13b, v21b, v22b, v23b, v31b, v32b, v33b] = MSE_b_3users_4antennas(Z11, Z12, Z13, Z21, Z22, Z23, Z31, Z32, Z33, g1b, g2b, g3b, n0);
            [v11c, v12c, v13c, v21c, v22c, v23c, v31c, v32c, v33c] = MSE_b_3users_4antennas(Z11, Z12, Z13, Z21, Z22, Z23, Z31, Z32, Z33, g1c, g2c, g3c, n0);
            v12c = [0;0;0;0];
            v13c = [0;0;0;0];
            v21c = [0;0;0;0];
            v23c = [0;0;0;0];
            ...
            [v11, v12, v13, v21, v22, v23, v31, v32, v33] = Primal_Dual_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, g1, g2, g3, P, n0);
            %{
            ...
            %}
            MSE_Cal_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, v11, v12, v13,v21,v22,v23,v31,v32,v33,g1, g2, g3, P, n0)
            MSE_Cal_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, v11b, v12b, v13b,v21b,v22b,v23b,v31b,v32b,v33b,g1b, g2b, g3b, P, n0)
            MSE_Cal_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, v11c, v12c, v13c,v21c,v22c,v23c,v31c,v32c,v33c,g1c, g2c, g3c, P, n0)
            P;
            %%%Verification
            %{
            ...
            [g1, g2, g3] = MSE_f_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, v11, v12, v13, v21, v22, v23, v31, v32, v33, n0);
            [g1b, g2b, g3b] = MSE_f_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, v11b, v12b, v13b, v21b, v22b, v23b, v31b, v32b, v33b, n0);
            [g1c, g2c, g3c] = MSE_f_3users_4antennas(H11, H12, H13, H21, H22, H23, H31, H32, H33, v11c, v12c, v13c, v21c, v22c, v23c, v31c, v32c, v33c, n0);
...
p2=plot(iternums, mean(C1b)+mean(C2b)+mean(C3b),'*');
p3=plot(iternums, mean(C1c)+mean(C2c)+mean(C3c),'s');

axis([1 numiters 0 40])

xlabel('Number of iterations')
ylabel('C(bits/channel)')
title('Capacity vs. Iterations: 3 users;4 antennas;P=1;n0=10^{-3};100 realizations')
