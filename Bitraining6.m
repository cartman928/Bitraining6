  ...
  %}
    ...
    for numiters = 1:length(iternums)
        ...
        %% bi-directional training
            ...
            [g1, g2, g3] = MSE(H11, H12, H13, H21, H22, H23, H31, H32, H33, v11, v12, v13, v21, v22, v23, v31, v32, v33, n0);
            %norm(g1)^2
            %norm(g2)^2
            ...
            SINR1 = norm(g11'*(H11*v11+H12*v21+H13*v31))^2/(norm(g1'*(H11*v12+H12*v22+H13*v32))^2+norm(g1'*(H11*v13+H12*v23+H13*v33))^2+n0*g1'*g1);
            SINR2 = norm(g22'*(H21*v12+H22*v22+H23*v32))^2/(norm(g2'*(H21*v11+H22*v21+H23*v31))^2+norm(g2'*(H21*v13+H22*v23+H23*v33))^2+n0*g2'*g2);
            SINR3 = norm(g33'*(H31*v13+H32*v23+H33*v33))^2/(norm(g3'*(H31*v12+H32*v22+H33*v32))^2+norm(g3'*(H31*v12+H32*v22+H33*v32))^2+n0*g3'*g3);
