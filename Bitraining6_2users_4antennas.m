...
for Realization = 1 : N_Realizations
    ...
    for numiters = 1:length(iternums)
        ...
        %% bi-directional training
            ...
            [v11b, v12b, v21b, v22b] = MSE_b_2users_4antennas(Z11, Z12, Z21, Z22, g1b, g2b, n0);
            [v11c, v12c, v21c, v22c] = MSE_b_2users_4antennas(Z11, Z12, Z21, Z22, g1c, g2c, n0);
            v12c = [0;0;0;0];
            v21c = [0;0;0;0];
            ...
            [v11, v12, v21, v22] = Primal_Dual_2users_4antennas(H11, H12, H21, H22, g1, g2, P, n0);
            ...
            [g1, g2] = MSE_f_2users_4antennas(H11, H12, H21, H22, v11, v12,  v21, v22, n0);
            [g1b, g2b] = MSE_f_2users_4antennas(H11, H12, H21, H22, v11b, v12b, v21b, v22b, n0);
            [g1c, g2c] = MSE_f_2users_4antennas(H11, H12, H21, H22, v11c, v12c, v21c, v22c, n0);
...
axis([1 numiters 20 30])

xlabel('Number of iterations')
ylabel('C(bits/channel)')
title('Capacity vs. Iterations: 2 users;4 antennas;P=1;n0=10^{-3};100 realizations')
